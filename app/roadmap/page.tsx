      ...
      <div className="container mx-auto px-4 md:px-8 py-8 md:py-12">
        ...
        <div className="hidden md:block relative">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 h-full flex flex-col items-center">
            {/* Step 1 Arrow - Blue */}
            <div className="w-[60px] h-[180px] bg-[#4a6d8b] diamond-arrow relative">
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[12px] h-[12px] rounded-full bg-white"></div>
              <div className="absolute top-1/2 left-full w-[120px] border-t-2 border-dotted border-[#4a6d8b]"></div>
            </div>

            {/* Step 2 Arrow - Teal */}
            <div className="w-[60px] h-[180px] bg-[#56afaf] diamond-arrow relative">
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[12px] h-[12px] rounded-full bg-white"></div>
              <div className="absolute top-1/2 left-full w-[120px] border-t-2 border-dotted border-[#56afaf]"></div>
            </div>

            {/* Step 3 Arrow - Yellow/Gold */}
            <div className="w-[60px] h-[180px] bg-[#c49845] diamond-arrow relative">
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[12px] h-[12px] rounded-full bg-white"></div>
              <div className="absolute top-1/2 left-full w-[120px] border-t-2 border-dotted border-[#c49845]"></div>
            </div>

            {/* Step 4 Arrow - Red */}
            <div className="w-[60px] h-[180px] bg-[#c83434] diamond-arrow relative">
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[12px] h-[12px] rounded-full bg-white"></div>
              <div className="absolute top-1/2 left-full w-[120px] border-t-2 border-dotted border-[#c83434]"></div>
            </div>

            {/* Step 5 Arrow - Green */}
            <div className="w-[60px] h-[180px] bg-[#49af45] diamond-arrow relative">
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[12px] h-[12px] rounded-full bg-white"></div>
              <div className="absolute top-1/2 left-full w-[120px] border-t-2 border-dotted border-[#49af45]"></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* Step 2 */}
            <div className="col-span-1 pr-16 mb-20"></div>
            <div className="col-span-1 pl-16 mb-20 relative">
            ...
            <div className="col-span-1 pr-16 text-right mb-20">
              ...
              <p className="text-sm">
                Ministry of Justice to commence drafting of constitution of Zambia (Amendment) Bill, 2025 (after
                obtaining Report from Electoral Commission of Zambia
              </p>
            </div>
            <div className="col-span-1 pl-16 mb-20 relative">
